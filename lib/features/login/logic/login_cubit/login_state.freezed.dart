...
mixin _$LoginState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiErrorModel errorModel) loginError,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ApiErrorModel errorModel)? loginError,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$LoginErrorImpl<T> implements LoginError<T> {
  const _$LoginErrorImpl(this.errorModel);
  ...
  @override
  String toString() {
    return 'LoginState<$T>.loginError(errorModel: $errorModel)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loginError?.call(errorModel);
  }
...
abstract class LoginError<T> implements LoginState<T> {
  const factory LoginError(final ApiErrorModel errorModel) =
      _$LoginErrorImpl<T>;
